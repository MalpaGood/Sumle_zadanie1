...
option = st.selectbox(
    ...
    [
        ...
        "Tłumaczenie z języka angielkskiego na język niemiecki",
    ],
)
...
if option == "Tłumaczenie z języka angielkskiego na język niemiecki":
    text = st.text_area(label="Wpisz tekst")
    if text:
        with st.spinner("Tłumaczę tekst..."):
            try:
                ...
                st.write("**Oryginał (EN):**", text)
                st.write("**Tłumaczenie (DE):**", translation[0]['translation_text'])
